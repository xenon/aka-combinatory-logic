module CombinatoryLogic {
    ...
    export function termToString(e: CLTerm): string {
    ...
    export function stringToTerm(s: string): CLTerm {
    ...
    export function reduceToNormalForm(e: CLTerm): CLTerm {
